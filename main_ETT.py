...
data = pd.read_csv('data/ETDataset-main/ETT-small/ETTh1.csv')
df = data
df = df.iloc[:,:]
...
list_w1 = [2,4,5,10,25]
list_rank1 = np.linspace(5.0,30.0,num=26,endpoint=True)
list_rank1 = list_rank1.astype(int)
periodicity1 = 7

list_w2 = [5]
list_rank2 = list_rank1
...
data = pd.read_csv('data/ETDataset-main/ETT-small/ETTh2.csv')
df = data
df = df.iloc[:,:]
...
data = pd.read_csv('data/ETDataset-main/ETT-small/ETTm1.csv')
df = data
df = df.iloc[:,:]
...
data = pd.read_csv('data/ETDataset-main/ETT-small/ETTm2.csv')
df = data
df = df.iloc[:,:]
