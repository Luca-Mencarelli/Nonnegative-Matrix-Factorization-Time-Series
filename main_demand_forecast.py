...
data = pd.io.parsers.read_csv('data/Daily_Demand_Forecasting_Orders.csv', sep=";", index_col=0, header=0, low_memory=False, decimal='.')
df = data.reset_index()
df = df.iloc[:,2:].transpose()
print(df)

name = "demand_forecast_"
...
list_w1 = [2,3]
list_rank1 = [5,10,15,20,25,30,35,40]
periodicity1 = 5

list_w2 = [2,3]
list_rank2 = [5,10,15,20,25,30,35,40]
