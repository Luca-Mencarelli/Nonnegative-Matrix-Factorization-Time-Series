...
data = pd.io.parsers.read_csv('data/gas+sensor+array+under+flow+modulation.csv', sep=",", index_col=0, header=0, low_memory=False, decimal='.')
df = data
df = df.iloc[:-2,6:]
...
list_w1 = [2,7]
list_rank1 = [2,5,10,20,30,35]
periodicity1 = 4

list_w2 = [2]
list_rank2 = [2,5,10,20,30,35]
